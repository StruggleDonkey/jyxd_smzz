...
public class Wang1Jianchashenqing {
    /*public static void main(String[] args) throws Exception {
        *//*String msg = "MSH|^~\\&|HIS|JHIP|JHIP|JHIP|20150118160551||ORM^O01^ORM_O01|JHIP201503181524|P|2.4\r"+
                ...
                "DG1|1|慢性阻塞性肺病||慢性阻塞性肺病||F\r";*//*
        *//*String msg="MSH|^~\\&|Mindray|Gateway|||||ORU^R01|2|P|2.3.1| \r" +
                "PID|||M1015_00010||张^三||20091112|M|||^^^^||| \r" +
                "PV1||I|^^ICU&Bed5&3232241659&0&0|||||||||||||||A||||||||||||||||||||||||||20091201111211 \r" +
                "OBR||||Mindray Monitor|||20091203121631| \r" +
                "OBX||NM|52^Height||169.0||||||F \r" +
                "OBX||NM|51^Weight||59.0||||||F ";*//*

        String msg="MSH|^~\\&|Mindray|Gateway|||||ORU^R01|2|P|2.3.1| PID|||M1015_00010||?^?||20091112|M|||^^^^||| PV1||I|^^ICU&Bed5&3232241659&0&0|||||||||||||||A||||||||||||||||||||||||||20091201111211 OBR||||Mindray Monitor|||20091203121631| ";
        ...
        String obx=terser.get("/.OBX-5");//obx
...
*/
    public static void toHl7(String msg){
        try {
            System.out.println("---------------------------");
            PipeParser pipeParser = new PipeParser();
            Message message = pipeParser.parse(msg);
            Terser terser = new Terser(message);
            System.out.println("嘿嘿嘿开始了:"+terser.toString());
            String sex=terser.get("/.PID-8");//性别
            System.out.println("性别:"+sex);
